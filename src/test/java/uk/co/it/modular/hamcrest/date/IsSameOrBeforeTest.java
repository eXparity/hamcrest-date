...
import static uk.co.it.modular.hamcrest.date.DateMatchers.sameOrBefore;
...
public class IsSameOrBeforeTest {
	...
	public void canCompareABeforeDate() {
		assertThat(JAN_1ST_2012_11_AM_GMT, sameOrBefore(JAN_1ST_2012_11_PM));
	}

	@Test
	public void canCompareALaterDate() {
		assertThat(JAN_1ST_2012_11_PM, not(sameOrBefore(JAN_1ST_2012_11_AM_GMT)));
	}
