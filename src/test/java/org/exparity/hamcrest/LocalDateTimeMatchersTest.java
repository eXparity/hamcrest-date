...
public class LocalDateTimeMatchersTest {
	...
	private static final LocalDateTime JAN_1_2015 = LocalDateTime.of(2015, Month.JANUARY, 1, 12, 0, 0);
	private static final LocalDateTime FEB_1_2015 = LocalDateTime.of(2015, Month.FEBRUARY, 1, 12, 0, 0);
	private static final LocalDateTime MAR_1_2015 = LocalDateTime.of(2015, Month.MARCH, 1, 12, 0, 0);
	private static final LocalDateTime APR_1_2015 = LocalDateTime.of(2015, Month.APRIL, 1, 12, 0, 0);
	private static final LocalDateTime MAY_1_2015 = LocalDateTime.of(2015, Month.MAY, 1, 12, 0, 0);
	private static final LocalDateTime JUN_1_2015 = LocalDateTime.of(2015, Month.JUNE, 1, 12, 0, 0);
	private static final LocalDateTime JUL_1_2015 = LocalDateTime.of(2015, Month.JULY, 1, 12, 0, 0);
	private static final LocalDateTime AUG_1_2015 = LocalDateTime.of(2015, Month.AUGUST, 1, 12, 0, 0);
	private static final LocalDateTime AUG_3_2015 = LocalDateTime.of(2015, Month.AUGUST, 3, 12, 0, 0);
	private static final LocalDateTime AUG_4_2015 = LocalDateTime.of(2015, Month.AUGUST, 4, 12, 0, 0);
	private static final LocalDateTime AUG_5_2015 = LocalDateTime.of(2015, Month.AUGUST, 5, 12, 0, 0);
	private static final LocalDateTime AUG_6_2015 = LocalDateTime.of(2015, Month.AUGUST, 6, 12, 0, 0);
	private static final LocalDateTime AUG_7_2015 = LocalDateTime.of(2015, Month.AUGUST, 7, 12, 0, 0);
	private static final LocalDateTime AUG_8_2015 = LocalDateTime.of(2015, Month.AUGUST, 8, 12, 0, 0);
	private static final LocalDateTime AUG_9_2015 = LocalDateTime.of(2015, Month.AUGUST, 9, 12, 0, 0);
	private static final LocalDateTime AUG_31_2015 = LocalDateTime.of(2015, Month.AUGUST, 31, 12, 0, 0);
	private static final LocalDateTime SEP_4_2015 = LocalDateTime.of(2015, Month.SEPTEMBER, 4, 12, 0, 0);
	private static final LocalDateTime SEP_30_2015 = LocalDateTime.of(2015, Month.SEPTEMBER, 30, 12, 0, 0);
	private static final LocalDateTime OCT_1_2015 = LocalDateTime.of(2015, Month.OCTOBER, 1, 12, 0, 0);
	private static final LocalDateTime NOV_1_2015 = LocalDateTime.of(2015, Month.NOVEMBER, 1, 12, 0, 0);
	private static final LocalDateTime DEC_1_2015 = LocalDateTime.of(2015, Month.DECEMBER, 1, 12, 0, 0);
	private static final LocalDateTime AUG_4_2016 = LocalDateTime.of(2016, Month.AUGUST, 4, 1, 12, 0, 0);
	private static final Date AUG_3_2015_AS_DATE = FluentDateTime.AUG(3, 2015).at(12, 0, 0);
	private static final Date AUG_4_2015_AS_DATE = FluentDateTime.AUG(4, 2015).at(12, 0, 0);
	private static final Date AUG_5_2015_AS_DATE = FluentDateTime.AUG(5, 2015).at(12, 0, 0);
	private static final Date SEP_4_2015_AS_DATE = FluentDateTime.SEP(4, 2015).at(12, 0, 0);
	private static final Date AUG_4_2016_AS_DATE = FluentDateTime.AUG(4, 2016).at(12, 0, 0);
	...
	public void canTestAfterWithEarlierDMY() {
		assertThat(AUG_4_2015, after(2015, AUGUST, 3, 12, 0, 0));
	}

	@Test(expected = AssertionError.class)
	public void canTestAfterWithSameDMY() {
		assertThat(AUG_4_2015, after(2015, AUGUST, 4, 12, 0, 0));
	}

	@Test(expected = AssertionError.class)
	public void canTestAfterWithLaterDDMY() {
		assertThat(AUG_4_2015, after(2015, AUGUST, 5, 12, 0, 0));
	}
	...
	public void canTestBeforeWithEarlierDMY() {
		assertThat(AUG_4_2015, before(2015, AUGUST, 3, 12, 0, 0));
	}

	@Test(expected = AssertionError.class)
	public void canTestBeforeWithSameDMY() {
		assertThat(AUG_4_2015, before(2015, AUGUST, 4, 12, 0, 0));
	}

	@Test
	public void canTestBeforeWithLaterDDMY() {
		assertThat(AUG_4_2015, before(2015, AUGUST, 5, 12, 0, 0));
	}
	...
	public void canTestSameDayWithEarlierDMY() {
		assertThat(AUG_4_2015, sameDay(2015, AUGUST, 3, 12, 0, 0));
	}

	@Test
	public void canTestSameDayWithSameDMY() {
		assertThat(AUG_4_2015, sameDay(2015, AUGUST, 4, 12, 0, 0));
	}

	@Test(expected = AssertionError.class)
	public void canTestSameDayWithLaterDDMY() {
		assertThat(AUG_4_2015, sameDay(2015, AUGUST, 5, 12, 0, 0));
	}
	...
	public void canTestSameOrBeforeWithEarlierDMY() {
		assertThat(AUG_4_2015, sameOrBefore(2015, AUGUST, 3, 12, 0, 0));
	}

	@Test
	public void canTestSameOrBeforeWithSameDMY() {
		assertThat(AUG_4_2015, sameOrBefore(2015, AUGUST, 4, 12, 0, 0));
	}

	@Test
	public void canTestSameOrBeforeWithLaterDDMY() {
		assertThat(AUG_4_2015, sameOrBefore(2015, AUGUST, 5, 12, 0, 0));
	}
	...
	public void canTestSameOrAfterWithEarlierDMY() {
		assertThat(AUG_4_2015, sameOrAfter(2015, AUGUST, 3, 12, 0, 0));
	}

	@Test
	public void canTestSameOrAfterWithSameDMY() {
		assertThat(AUG_4_2015, sameOrAfter(2015, AUGUST, 4, 12, 0, 0));
	}

	@Test(expected = AssertionError.class)
	public void canTestSameOrAfterWithLaterDDMY() {
		assertThat(AUG_4_2015, sameOrAfter(2015, AUGUST, 5, 12, 0, 0));
	}
	...
	public void canTestWithinIntervalDMY() {
		assertThat(AUG_3_2015, within(1, ChronoUnit.DAYS, 2015, AUGUST, 4, 12, 0, 0));
	}

	@Test(expected = AssertionError.class)
	public void canTestWithinOutsideIntervalDMY() {
		assertThat(AUG_3_2015, within(1, ChronoUnit.DAYS, 2015, AUGUST, 5, 12, 0, 0));
	}
