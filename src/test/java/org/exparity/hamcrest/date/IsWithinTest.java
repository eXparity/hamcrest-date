...
public class IsWithinTest {
	...
	public void canCompareDatesWithinLimitDay() {
		assertThat(JAN_01_2012_11AM_AS_DATE, within(2, TimeUnit.DAYS, 2012, Months.JAN, 2));
	}

	@Test(expected = AssertionError.class)
	public void canCompareDatesNotWithinLimitDay() {
		assertThat(JAN_01_2012_11AM_AS_DATE, within(2, TimeUnit.DAYS, 2012, Months.JAN, 6));
	}

	@Test
	public void canCompareDatesWithinLimitDayMonthYear() {
		assertThat(JAN_01_2012_11AM_AS_DATE, within(2, TimeUnit.DAYS, new DayMonthYear(2, Months.JAN, 2012)));
	}

	@Test(expected = AssertionError.class)
	public void canCompareDatesNotWithinLimitDayMonthYear() {
		assertThat(JAN_01_2012_11AM_AS_DATE, within(2, TimeUnit.DAYS, new DayMonthYear(6, Months.JAN, 2012)));
	}

	@Test
	public void canCompareDatesWithinLimitTime() {
		assertThat(JAN_01_2012_11AM_AS_DATE, within(10, TimeUnit.SECONDS, 2012, Months.JAN, 1, 11, 00, 00, 000));
	}

	@Test(expected = AssertionError.class)
	public void canCompareDatesNotWithinLimitTime() {
		assertThat(JAN_01_2012_11AM_AS_DATE, within(10, TimeUnit.SECONDS, 2012, Months.JAN, 1, 11, 00, 11, 000));
	}
