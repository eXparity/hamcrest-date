...
public class ZonedDateTimeFormatterTest {
    ...
    public void canDescribe() {
        String description = new ZonedDateTimeFormatter(Locale.US).describe(Dates.AUG_04_2015_11AM_UTC);
        assertThat(description, Matchers.equalTo("Tue, 04 Aug 2015 11:59:00.000 AM +0000"));
    }

    @Test
    public void canDescribeDate() {
        String description = new ZonedDateTimeFormatter(Locale.US).describeDate(Dates.AUG_04_2015_11AM_UTC);
