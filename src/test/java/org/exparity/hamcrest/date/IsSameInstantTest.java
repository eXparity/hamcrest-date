...
public class IsSameInstantTest {
	...
	public void canCompareTheSameLinuxTimstamp() {
		assertThat(JAN_01_2012_11AM_GMT_AS_DATE, sameInstant(1325415600000L));
	}

	@Test
	public void canDetectDifferentLinuxTimstamp() {
		assertThat(JAN_01_2012_11AM_AS_DATE, not(sameInstant(1L)));
	}

	@Test
	public void canCompareTheSameFullTime() {
		assertThat(JAN_01_2012_11AM_AS_DATE, sameInstant(2012, Months.JANUARY, 1, 11, 00, 00, 000));
	}

	@Test
	public void canDetectDifferentFullTime() {
		assertThat(JAN_01_2012_11AM_AS_DATE, not(sameInstant(2012, Months.JANUARY, 1, 11, 00, 00, 1)));
	}
