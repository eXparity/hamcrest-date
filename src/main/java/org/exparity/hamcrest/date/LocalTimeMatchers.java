 ...
 * comparing {@link LocalTime} instances
 *
...
public abstract class LocalTimeMatchers {
	...
	/**
	 * Creates a matcher that matches when the examined time is after the
	 * reference time
	 * <p/>
	 * For example:
	 *
	 ...
	 *
	 * @param time
	 *            the reference time against which the examined time is checked
	 */
	...
	/**
	 * Creates a matcher that matches when the examined time is after the end of
	 * the reference year
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is before the
	 * reference time
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is before the end
	...
	/**
	 * Creates a matcher that matches when the examined time is at the same
	 * instant or before the reference time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same day
	 * or before the start of the reference time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined time is at the same
	 * instant or after the reference time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same day
	 * or after the start of the reference time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined time is within a defined
	...
	/**
	 * Creates a matcher that matches when the examined time is within a given
	 ...
	 *
	 * @param period
	 *            the timeunit interval the examined time should be with
	 * @param unit
	 ...
	 *            the second of the minute
	 */
	public static Matcher<LocalTime> within(final long period, final ChronoUnit unit, final int hour, final int minute,
			final int second) {
		return new IsWithin<LocalTime>(period, unit, new LocalTimeWrapper(hour, minute, second),
				new LocalTimeFormatter());
	}

	/**
	 * Creates a matcher that matches when the examined time is on the maximum
	 * value of the given time part in its period
	 * <p/>
	 * For example:
	 *
	 * <pre>
	 * assertThat(myTime, isMinimum(ChronoField.MINUTE_OF_HOUR));
	 * </pre>
	 *
	 * @param field
	 *            the temporal field to check
	 */
	public static Matcher<LocalTime> isMinimum(final TemporalField field) {
		return new IsMinimum<LocalTime>(field, t -> t);
	}
	 ...
	 *
	 * <pre>
	 * assertThat(myTime, isMaximum(ChronoField.MINUTE_OF_HOUR));
	 * </pre>
	 *
	 * @param field
	 *            the temporal field to check
	 */
	public static Matcher<LocalTime> isMaximum(final TemporalField field) {
		return new IsMaximum<LocalTime>(field, t -> t);
	}

	/**
	 * Creates a matcher that matches when the examined time is on the expected
	 * hour (0-23)
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same hour
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same
	 * minute as the reference time
	 * <p/>
	 * For example:
	 *
	 * <pre>
